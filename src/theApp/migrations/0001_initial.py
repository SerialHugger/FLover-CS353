# Generated by Django 3.0.6 on 2020-05-22 04:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occasion', models.TextField(max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userType', models.TextField(max_length=64)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            name='Courier',
            fields=[
                ('myuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='theApp.myUser')),
        ...
        migrations.CreateModel(
            name='Customer',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='theApp.myUser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='theApp.myUser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='theApp.myUser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='theApp.myUser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cust_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='theApp.myUser')),
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='theApp.Order')),
            ],
            options={
